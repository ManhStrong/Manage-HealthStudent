 ...
 * @author HQuan
 */
public class TableDonXinNghiGV extends AbstractTableModel {

    private String Name[] = {"Mã đơn", "Mã giáo viên", "Lý do", "Ảnh", "TTSK", "Ngày nộp", "Ngày bắt đầu", "Ngày kết thúc", "Trạng thái"};
    ...
    TreeSet<DonXinNghiGV> dxns = new TreeSet<DonXinNghiGV>();

    public TableDonXinNghiGV(TreeSet<DonXinNghiGV> dxns) {
        this.dxns = dxns;
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ArrayList<DonXinNghiGV> newDxns = new ArrayList<DonXinNghiGV>(dxns);
        switch (columnIndex) {
            case 0:
                return newDxns.get(rowIndex).getMaDon();

            case 1:
                return newDxns.get(rowIndex).getMaGV();
