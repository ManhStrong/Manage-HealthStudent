 ...
 * @author trqhu
 */
public class TableDonXinNghiSVSort extends AbstractTableModel {
    ...
    ArrayList<DonXinNghiSV> dxns = new ArrayList<DonXinNghiSV>();

    public TableDonXinNghiSVSort(ArrayList<DonXinNghiSV> dxns) {
        this.dxns = dxns;
    }
